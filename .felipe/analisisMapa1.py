...
if not cap.isOpened():
    ...
    while True:
        ...
        detected_shapes, frame_with_shapes = detect_shapes_in_image(frame, rows, cols, threshold1, threshold2,
                                                                    dilatacion)
        ...
        recorrido = LogicMove.recorrer_mapa(maze, detected_shapes)
        print(f"El recorrido del robot es: {recorrido}")

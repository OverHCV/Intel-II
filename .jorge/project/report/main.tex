...
\documentclass[
    ...
    coverstyle=classic
]{MainThesis} % Refer to the Wiki for a list of available options.
...
%%% Additional Packages for Hypothesis Verification Boxes %%%
...
%%% Chapters (**Research Paper Structure**) %%%
\include{Chapters/01-Introduction}
\include{Chapters/02-Related-Work}
\include{Chapters/03-Methodology}
\include{Chapters/04-Experiments-Results}
